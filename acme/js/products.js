...
function buildProductList(data) { 
    ...
    dataTable += '<tbody class="prodModDel">'; 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td> <a href='/acme/products/index.php?action=mod&invId=${element.invId}' title='Click to modify'>Modify</a></td>`; 
     dataTable += `<td> <a href='/acme/products/index.php?action=del&invId=${element.invId}' title='Click to delete'>Delete</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
